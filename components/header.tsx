          ...
          <div className="flex items-center gap-4">
            <SignedIn>
              <Link href="/manage-plan">
                <Button className="mr-4 bg-gradient-to-r from-blue-600 to-blue-400 text-transparent bg-clip-text">Manage Plan</Button>
              </Link>

              <div className="p-2 w-10 h-10 flex item-center justify-center rounded-full border bg-blue-50 border-blue-200">
                <UserButton />
              </div>
            </SignedIn>
