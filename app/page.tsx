...
const features = [
  {
    title: "AI Analysis",
    description:
      "Get deap insights into your video content with our advanced AI analysis. Understand viewer engagement and content quality.",
    icon: Brain,
    iconBg: "bg-blue-100",
  ...
  },
  {
    title: "Shot Script",
    description:
      "Get detailed, step-by-step instructinos to recreate viral videos. Learn shooting techniques, angles, and editing tips from successful content.",
    icon: Video,
    iconBg: "bg-red-100",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, idx: number) => {
              ...
              return (
                <div
                  key={idx}
                  className="text-center p-6 bg-white shadow-md hover:shadow-lg transition-all"
                >
